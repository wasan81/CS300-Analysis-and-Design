...
void LinkedList::Prepend(Bid bid) {
    ...
    if (head != nullptr) {
        ...
        // If the list is empty, both head and tail should be the new node
        head = new_node;
        tail = new_node;
    }
...
void LinkedList::PrintList() {
    // Start at the head
    Node* current = head;
    // while loop looking for a match
    while (current != nullptr) {
        // Output current bid information
        cout << current->bid.bidId << ": " << current->bid.title << " | " << current->bid.fund << " | " << current->bid.amount << endl;
...
void LinkedList::Remove(string bidId) {
    ...
    while (current != nullptr) {
        ...
        if (current->bid.bidId == bidId) {
            ...
            // Make the current node point beyond the next node
            if (prev != nullptr) {
                prev->next = temp;
            }
...
Bid LinkedList::Search(string bidId) {
    ...
    // Bid with the specified bidId not found, return an empty bid
    Bid null;
    return null;
}
